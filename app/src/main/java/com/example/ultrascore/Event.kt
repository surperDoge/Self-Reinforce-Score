...
//每日挑战
class Event_Daily(content_b:String,val plus_score_b:Int,val minus_score_b:Int,var series_b:Int,val state_b:Boolean,val time:Int,val last:Int,val create:Calendar)
